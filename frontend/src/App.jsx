...
function App() {
  ...
  return (
    <div className="flex min-h-screen bg-neutral-950 text-slate-100 overflow-x-hidden">
      {/* Sidebar Navigation */}
      <aside className="w-64 bg-neutral-950 border-r border-neutral-800 flex flex-col justify-between flex-shrink-0 z-10">
        <div>
          {/* Logo Brand */}
