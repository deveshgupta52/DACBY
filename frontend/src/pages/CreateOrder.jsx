...
const CreateOrder = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-600/20 rounded-full blur-3xl -z-10 animate-pulse delay-700"></div>
      ...
      <div className="w-full max-w-xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Generate and dispatch customer orders instantly.
          </p>
        </div>

        {/* Success State */}
        {successOrder ? (
          <div className="backdrop-blur-xl bg-slate-900/60 border border-emerald-500/30 rounded-2xl p-8 shadow-2xl relative overflow-hidden transition-all duration-500 transform hover:scale-[1.01]">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <button
                ...
                className="mt-8 px-6 py-2.5 w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-semibold rounded-xl transition-all duration-200 transform active:scale-95 shadow-lg shadow-indigo-600/20"
              >
          ...
          /* Glassmorphic Form */
          <form onSubmit={handleSubmit} className="backdrop-blur-xl bg-slate-900/40 border border-slate-800 rounded-2xl p-8 shadow-2xl relative transition-all duration-300">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 bg-slate-950/50 border rounded-xl text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 ${
                      validationErrors.customerName ? 'border-red-500/50' : 'border-slate-800'
                    }`}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 bg-slate-950/50 border rounded-xl text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 ${
                      validationErrors.phoneNumber ? 'border-red-500/50' : 'border-slate-800'
                    }`}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-11 pr-4 py-3 bg-slate-950/50 border rounded-xl text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 ${
                      validationErrors.productName ? 'border-red-500/50' : 'border-slate-800'
                    }`}
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0.01"
                    className={`w-full pl-11 pr-4 py-3 bg-slate-950/50 border rounded-xl text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 ${
                      validationErrors.amount ? 'border-red-500/50' : 'border-slate-800'
                    }`}
                  />
                </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-8 w-full py-3.5 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-500 hover:via-indigo-500 hover:to-purple-500 text-white font-semibold rounded-xl transition-all duration-200 transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed shadow-xl shadow-indigo-600/10 flex items-center justify-center space-x-2"
            >
              {loading ? (
                <>
